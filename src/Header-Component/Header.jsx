...
function Header() {
    return (
        <div className="flex  bg-white justify-around gap-20 md:gap-x-96 lg: lg:fixed lg:bg-white top-0 left-0 w-full   lg:h-24  z-10">
            ...
            <div className="hidden lg:flex lg:absolute right-5 translate-y-1/2 justify-end items-center gap-2">
                <a href="#AboutUs">
                    <Button variant="text" style={{ color: 'rgba(41, 37, 36, 0.9)', fontWeight: 700, fontSize: 20,cursor:"pointer",animationDuration:'200' }}>About</Button>
                </a>
